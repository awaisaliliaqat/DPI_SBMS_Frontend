...
// Note: Status mapping (under_review/ceo_pending -> quotation sent) is handled by the backend API
 ...
 * Note: Status mapping (under_review/ceo_pending -> quotation sent) is now handled by the backend API
